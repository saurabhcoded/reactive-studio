import { useActiveObject, useContextMenuRequest } from "@layerhub-io/react";
...
const ContextMenuItem = ({ label, onClick, children, disabled = false }: { icon: string; label: string; onClick: () => void; disabled?: boolean; children: React.ReactNode }) => {
