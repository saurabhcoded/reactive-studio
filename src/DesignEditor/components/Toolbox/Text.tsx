...
const Text = () => {
  ...
  return (
    <Block style={{ flex: 1, display: "flex", alignItems: "center", padding: "0 12px", justifyContent: "space-between" }}>
      <Block display="flex" gridGap="0.5rem" alignItems="center">
        ...
        <Block display="flex" alignItems="center">
          <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType="tooltip" content="Text color">
          ...
          <StatefulTooltip placement={PLACEMENT.bottom} showArrow accessibilityType="tooltip" content="Bold">
            <Button style={{ ...(!state.bold && { color: "rgb(169,169,169)" }) }} disabled={!state.styleOptions.hasBold} onClick={makeBold} size={SIZE.mini} kind={KIND.tertiary}>
              <Bold size={20} />
            </Button>
          </StatefulTooltip>

          <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType="tooltip" content="Italic">
            <Button style={{ ...(!state.italic && { color: "rgb(169,169,169)" }) }} disabled={!state.styleOptions.hasItalic} onClick={makeItalic} size={SIZE.mini} kind={KIND.tertiary}>
              <Italic size={20} />
            </Button>
          </StatefulTooltip>

          <StatefulTooltip placement={PLACEMENT.bottom} showArrow={true} accessibilityType="tooltip" content="Underline">
            <Button style={{ ...(!state.underline && { color: "rgb(169,169,169)" }) }} onClick={makeUnderline} size={SIZE.mini} kind={KIND.tertiary}>
              <Underline size={24} />
            </Button>
          </StatefulTooltip>
...
const TextAlign = () => {
  ...
  return (
    <StatefulPopover
      ...
      placement={PLACEMENT.bottom}
      content={() => (
        <Block padding="12px" backgroundColor="#ffffff" display="grid" gridTemplateColumns="1fr 1fr 1fr 1fr" gridGap="8px">
          <Button
